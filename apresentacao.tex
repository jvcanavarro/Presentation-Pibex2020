...
\hypersetup{
    pdftitle={Uso de Redes Neurais Profundas e Recorrentes para Reconhecimento de Fala em Português Brasileiro}
...
{\Large Uso de Redes Neurais Profundas e Recorrentes Para Reconhecimento de Fala em Português Brasileiro}
...
\date{\small{10 de Outubro de 2020}}
...
\date{
	\normalsize
    João Canavarro (\href{mailto:jvcanavarro@icen.ufpa.br}{\tt jvcanavarro@ufpa.br})\\[1pt]
